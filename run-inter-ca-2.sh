#!/bin/bash
export FABRIC_CA_SERVER_HOME="/etc/hyperledger/fabric-ca/ica-org2"
export FABRIC_CA_SERVER_CA_NAME="localhost"
export FABRIC_CA_SERVER_INTERMEDIATE_TLS_CERTFILES="/home/datlv/data/org2-ca-cert.pem"
...
PARENT_URL="https://rca-org2-admin:rca-org2-adminpw@localhost:7058"
TARGET_CHAINFILE="/home/datlv/data/org2-ca-chain.pem"
ORG="org2"
...
sed -i "s/port: 7054/port: 7059/g" $FABRIC_CA_SERVER_HOME/fabric-ca-server-config.yaml
...
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-server/fabric-ca-server start -b $BOOTSTRAP_USER_PASS"@localhost:7059" -u $PARENT_URL