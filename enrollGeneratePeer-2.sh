...
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-client/fabric-ca-client enroll -d -u "https://"$CA_ADMIN_USER_PASS"@localhost:7059"
...
ORG_CONTAINER_NAME=${ORG//./-}
  ...
  export FABRIC_CA_CLIENT_TLS_CERTFILES=$CA_CHAINFILE
  $GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-client/fabric-ca-client getcacert -d -u "https://localhost:7059" -M $ORG_MSP_DIR
  ...
  if [ $ADMINCERTS ]; then
     if [ ! -d $ORG_ADMIN_HOME ]; then
      ...
      export FABRIC_CA_CLIENT_TLS_CERTFILES=$CA_CHAINFILE
      $GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-client/fabric-ca-client enroll -d -u "https://"$ADMIN_NAME":"$ADMIN_PASS"@localhost:7059"
