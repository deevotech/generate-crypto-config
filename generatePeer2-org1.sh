...
export FABRIC_CA_CLIENT_HOME=/etc/hyperledger/peer/peer2-org1
...
export PEER_HOME=/etc/hyperledger/peer/peer2-org1
export PEER_HOST=peer2-org1
export PEER_NAME_PASS=peer2-org1:peer2-org1pw
export CORE_PEER_ID=peer2-org1
export CORE_PEER_ADDRESS=127.0.0.1:7051
export CORE_PEER_LOCALMSPID=org1MSP
export CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/peer/peer2-org1/msp
export CORE_VM_ENDPOINT=unix:///host/var/run/docker.sock
export CORE_VM_DOCKER_HOSTCONFIG_NETWORKMODE=net_fabric-ca
export CORE_LOGGING_LEVEL=DEBUG
export CORE_PEER_TLS_ENABLED=true
export CORE_PEER_TLS_CERT_FILE=/etc/hyperledger/peer/peer2-org1/tls/server.crt
export CORE_PEER_TLS_KEY_FILE=/etc/hyperledger/peer/peer2-org1/tls/server.key
export CORE_PEER_TLS_KEY_FILE_FOLDER="/etc/hyperledger/peer/peer2-org1//tls/serverkey/"
