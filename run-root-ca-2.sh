...
TARGET_CERTFILE="/home/datlv/data/org2-ca-cert.pem"
...
sed -i "s/port: 7054/port: 7058/g" \
   $FABRIC_CA_SERVER_HOME/fabric-ca-server-config.yaml
# Start the root CA
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-server/fabric-ca-server start -b rca-org2-admin:rca-org2-adminpw