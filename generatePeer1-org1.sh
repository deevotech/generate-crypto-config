...
export CORE_PEER_TLS_KEY_FILE_FOLDER="/etc/hyperledger/peer/tls/serverkey/"
...
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-client/fabric-ca-client enroll -d --enrollment.profile tls -u $ENROLLMENT_URL --csr.hosts $PEER_HOST
