...
export FABRIC_CA_CLIENT_HOME=/etc/hyperledger/peer/peer2-org2
export FABRIC_CA_CLIENT_TLS_CERTFILES=/home/datlv/data/org2-ca-chain.pem
export ENROLLMENT_URL=https://peer2-org2:peer2-org2pw@localhost:7059
export PEER_NAME=peer2-org2
export PEER_HOME=/etc/hyperledger/peer/peer2-org2
export PEER_HOST=peer2-org2
export PEER_NAME_PASS=peer2-org2:peer2-org2pw
export CORE_PEER_ID=peer2-org2
export CORE_PEER_ADDRESS=127.0.0.1:7051
export CORE_PEER_LOCALMSPID=org2MSP
export CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/peer/peer2-org2/msp
export CORE_VM_ENDPOINT=unix:///host/var/run/docker.sock
export CORE_VM_DOCKER_HOSTCONFIG_NETWORKMODE=net_fabric-ca
export CORE_LOGGING_LEVEL=DEBUG
export CORE_PEER_TLS_ENABLED=true
export CORE_PEER_TLS_CERT_FILE=/etc/hyperledger/peer/peer2-org2/tls/server.crt
export CORE_PEER_TLS_KEY_FILE=/etc/hyperledger/peer/peer2-org2/tls/server.key
export CORE_PEER_TLS_KEY_FILE_FOLDER="/etc/hyperledger/peer/peer2-org2/tls/serverkey/"
export CORE_PEER_TLS_ROOTCERT_FILE=/homde/datlv/data/org2-ca-chain.pem
export CORE_PEER_TLS_CLIENTAUTHREQUIRED=true
export CORE_PEER_TLS_CLIENTROOTCAS_FILES=/home/datlv/data/org2-ca-chain.pem
export CORE_PEER_TLS_CLIENTCERT_FILE=/home/datlv/data/tls/peer2-org2-client.crt
export CORE_PEER_TLS_CLIENTKEY_FILE=/home/datlv/data/tls/peer2-org2-client.key
export CORE_PEER_GOSSIP_USELEADERELECTION=true
export CORE_PEER_GOSSIP_ORGLEADER=false
export CORE_PEER_GOSSIP_EXTERNALENDPOINT=peer2-org2:7051
