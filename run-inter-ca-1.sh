#!/bin/bash
export FABRIC_CA_SERVER_HOME="/etc/hyperledger/fabric-ca/ica-org1"
export FABRIC_CA_SERVER_CA_NAME="localhost"
export FABRIC_CA_SERVER_INTERMEDIATE_TLS_CERTFILES="/home/datlv/data/org1-ca-cert.pem"
...
PARENT_URL="https://rca-org1-admin:rca-org1-adminpw@localhost:7056"
TARGET_CHAINFILE="/home/datlv/data/org1-ca-chain.pem"
ORG="org1"
...
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-server/fabric-ca-server start -b $BOOTSTRAP_USER_PASS"@localhost:7057" -u $PARENT_URL