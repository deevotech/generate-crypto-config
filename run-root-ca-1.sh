#!/bin/bash
export FABRIC_CA_SERVER_HOME="/etc/hyperledger/fabric-ca-1"
...
TARGET_CERTFILE="/home/datlv/data/org1-ca-cert.pem"
...
sed -i "s/port: 7054/port: 7056/g" $FABRIC_CA_SERVER_HOME/fabric-ca-server-config.yaml
# Start the root CA
$GOPATH/src/github.com/hyperledger/fabric-ca/cmd/fabric-ca-server/fabric-ca-server start -b rca-org1-admin:rca-org1-adminpw
